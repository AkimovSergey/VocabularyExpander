...
void TrayIcon::Start()
{
    ...
    connect(add_flash_card_Action, &QAction::triggered, this, &TrayIcon::s_AddFlashCard);
    ...
    auto show_dictionary_Action = new QAction(QIcon(":res/resources/show.png"), "Show dictionary", this);
